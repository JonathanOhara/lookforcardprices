...
public class Util {
	...
	public static String replaceAllAccent(String replacement) {
		...
		replacedString = replacedString.replaceAll("[דבאגה×]", "a");
		replacedString = replacedString.replaceAll("[דבאגה]".toUpperCase(), "a".toUpperCase());
		replacedString = replacedString.replaceAll("[יטךכ]", "e");
		replacedString = replacedString.replaceAll("[יטךכ]".toUpperCase(), "e".toUpperCase());
		replacedString = replacedString.replaceAll("[םלמן]", "i");
		replacedString = replacedString.replaceAll("[םלמן]".toUpperCase(), "i".toUpperCase());
		replacedString = replacedString.replaceAll("[ץףעפצ÷]", "o");
		replacedString = replacedString.replaceAll("[ץףעפצ]".toUpperCase(), "o".toUpperCase());
		replacedString = replacedString.replaceAll("[תשûü]", "u");
		replacedString = replacedString.replaceAll("[תשûü]".toUpperCase(), "u".toUpperCase());
		replacedString = replacedString.replaceAll("[ח]", "c");
		replacedString = replacedString.replaceAll("[ח]".toUpperCase(), "c".toUpperCase());
		replacedString = replacedString.replaceAll("[ס]", "n");
		replacedString = replacedString.replaceAll("[ס]".toUpperCase(), "n".toUpperCase());
